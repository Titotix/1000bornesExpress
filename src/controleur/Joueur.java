...
public class Joueur {
	 ...
	 * Choix de la carte ï¿½ poser (parmis la main)
	 * Poser une carte sur son jeu
	 * Attaquer (poser une carte sur le jeu adverse)
	 * Dï¿½fausser(poser une carte dans la defausse)
	 * Choisir une cible
	...
	public void defausser(Carte carte) {
		...
		defausse.ajouterCarte(carte);  //ajoute la carte dÃ©fausser Ã  la dÃ©fausse
	}
